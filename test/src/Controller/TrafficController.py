...
class TrafficController:
    ...
    def create_traffic_light(self, x, y, lane: Lane):
        ...
        traffic_light_images = {
            TrafficStatus.red: self.design_traffic_image(traffic_light_images_dir, 'kirmizi.png', rotation),
            TrafficStatus.green: self.design_traffic_image(traffic_light_images_dir, 'yesil.png', rotation),
            TrafficStatus.yellow: self.design_traffic_image(traffic_light_images_dir, 'sari.png', rotation)
        }
