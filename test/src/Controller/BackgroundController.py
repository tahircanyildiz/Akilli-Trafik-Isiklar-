# Pygame; Python' ın oyun programlama denince akla ilk gelen kütüphanelerindendir.
# Pygame ile grafiksel şekiller çizmek, animasyon hazırlamak, ses dosyası oynatmak mümkündür.
import pygame
...
class BackgroundController:
   ...
   #varış oranı düğmelerini çiz
    def draw_spawn_rate_buttons(self):
        normal_font = pygame.font.SysFont('Comic Sans MS', 16)#sistem fontlarından bir Font nesnesi oluşturun
        underline_font = pygame.font.SysFont('Comic Sans MS', 16)
        underline_font.set_underline(True)#Etkinleştirildiğinde, tüm işlenmiş yazı tipleri bir alt çizgi içerecekt

        # Yatay şerit kontrolleri
